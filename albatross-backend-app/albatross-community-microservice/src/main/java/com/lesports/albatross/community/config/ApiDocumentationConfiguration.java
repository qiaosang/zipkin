...
public class ApiDocumentationConfiguration {
    ...
    public UiConfiguration uiconfig() {
        //UiConfiguration configuration = new UiConfiguration(null, "none", "alpha", "schema", null, false, true);
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.lesports.albatross.community.controller"))
                .build();
    }
}
